    ...
    try:
        ...
        if city_name:
            ...
            cache_check = cities_table.get_item(
                Key={'city': standardized_city_name, 'forecastType': 'weekly'}
            )
        ...
        # Sparse GSI: set or remove activeAlertStatus based on alerts toggle
        ...
        print(f"Executing update for user ID {user_id} with Expression: {update_expression}")
